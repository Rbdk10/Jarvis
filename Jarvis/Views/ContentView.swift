...
struct ContentView: View {
    ...
    /// Top-left stop sign — cancel whatever Jarvis is working on (thinking / connecting)
    /// and return to ready. Shown only while busy, never while either of you is talking.
